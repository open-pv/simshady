...
const sub1FirstTriangle:triangleUtils.Triangle = [vec3.fromValues(0.,0.,0.), vec3.fromValues(0.5,0.,0.), vec3.fromValues(0.,0.5,0.)]
const sub2FirstTriangle:triangleUtils.Triangle = [vec3.fromValues(1.,0.,0.), vec3.fromValues(0.5,0.5,0.), vec3.fromValues(0.5,0.,0.)]
const sub3FirstTriangle:triangleUtils.Triangle = [vec3.fromValues(0.,1.,0.), vec3.fromValues(0.0,0.5,0.), vec3.fromValues(0.5,0.5,0.)]
const sub4FirstTriangle:triangleUtils.Triangle = [vec3.fromValues(0.5,0.,0.), vec3.fromValues(0.5,0.5,0.), vec3.fromValues(0.,0.5,0.)]
...
describe('Triangle Util functions: ', () => {
    ...
    test('Subdivide triangles', () => {
      expect(triangleUtils.subdivide(firstTriangle)).toStrictEqual([sub1FirstTriangle, sub2FirstTriangle, sub3FirstTriangle, sub4FirstTriangle]);
    });
